...
void ShellScriptRandValStore::addRandValue(int randIdx, int val) { mRandValStore[randIdx] = val; }
...
void ShellScriptRandValStore::clear() { mRandValStore.clear(); }
ShellScriptRandValStore::ShellScriptRandValStore() {}

ShellScriptRandGetGen::ShellScriptRandGetGen(int randStoreIdx) { mRandStoreIdx = randStoreIdx; }
...
int ScriptParamIdxGen::generateParameter() { return mpLooper->getCurrentLoopIdx() + mRel; }

ScriptParamValGen::ScriptParamValGen(int val) { mVal = val; }
int ScriptParamValGen::generateParameter() { return mVal; }
